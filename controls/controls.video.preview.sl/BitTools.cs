...
namespace controls.video.preview.sl
{
    ...
    static public class BitTools
    {
        ...
        static public int MaskBits(byte[] data, int firstBit, int maskSize)
        {
        ...
        /// </returns>
        static public int ConvertSyncSafeToInt32(
            byte[] syncSafeData,
            int startIndex)
        {
            int integer = 0;
        ...
        /// </returns>
        static public int FindBitPattern(byte[] data, byte[] pattern, byte[] mask, int startIndex)
        {
            // GUARD
            if (data == null)
            {
        ...
        /// nothing was found or there was an error.
        /// </returns>
        static public int FindBitPattern(byte[] data, byte[] pattern, byte[] mask)
        {
        ...
        /// nothing was found or there was an error.
        /// </returns>
        static public int FindBytePattern(byte[] data, byte[] pattern, int startIndex)
        {
            // GUARD
            if (pattern == null)
            {
        ...
        /// nothing was found or there was an error.
        /// </returns>
        static public int FindBytePattern(byte[] data, byte[] pattern)
        {
