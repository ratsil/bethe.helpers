...
%NVCC% -m64 -arch=sm_20 -o "%PATH_CU%\Properties\Resources\CUDAFunctions.20.x64.cubin"
%NVCC% -m32 -arch=sm_20 -o "%PATH_CU%\Properties\Resources\CUDAFunctions.20.x32.cubin"
%NVCC% -m64 -arch=sm_21 -o "%PATH_CU%\Properties\Resources\CUDAFunctions.21.x64.cubin"
%NVCC% -m32 -arch=sm_21 -o "%PATH_CU%\Properties\Resources\CUDAFunctions.21.x32.cubin"
%NVCC% -m64 -arch=sm_30 -o "%PATH_CU%\Properties\Resources\CUDAFunctions.30.x64.cubin"
%NVCC% -m32 -arch=sm_30 -o "%PATH_CU%\Properties\Resources\CUDAFunctions.30.x32.cubin"
%NVCC% -m64 -arch=sm_35 -o "%PATH_CU%\Properties\Resources\CUDAFunctions.35.x64.cubin"
%NVCC% -m32 -arch=sm_35 -o "%PATH_CU%\Properties\Resources\CUDAFunctions.35.x32.cubin"
%NVCC% -m64 -arch=sm_50 -o "%PATH_CU%\Properties\Resources\CUDAFunctions.50.x64.cubin"
%NVCC% -m32 -arch=sm_50 -o "%PATH_CU%\Properties\Resources\CUDAFunctions.50.x32.cubin"
%NVCC% -m64 -arch=sm_52 -o "%PATH_CU%\Properties\Resources\CUDAFunctions.52.x64.cubin"